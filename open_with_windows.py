...
def install():
	...
	registry_locations = {
		...
		'opera': os.path.join('Software', 'Opera', 'NativeMessagingHosts'),
		'firefox': os.path.join('Software', 'Mozilla', 'NativeMessagingHosts'),
		'waterfox': os.path.join('Software', 'Waterfox', 'NativeMessagingHosts'),
	...
	for browser, registry_location in registry_locations.items():
		...
		if browser in ['firefox', 'thunderbird','waterfox']:
